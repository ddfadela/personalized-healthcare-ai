...
\title{A Data-Centric Perspective on AI-Driven Personalized Healthcare: From Genomics to Multimodal Integration}
...
\begin{figure}[h]
    \centering 
    \includegraphics[width=1.0\textwidth]{figures/multi_modal_data.png} 
